            ...
            >
              ...
              <CardContent className="space-y-2 pb-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-background rounded-lg p-2">
                    <p className="text-[10px] text-muted-foreground uppercase">Capital Deployed</p>
                    <p className="text-sm font-semibold" data-testid="result-capital-deployed">{formatCurrency(results.totalCapitalDeployed)}</p>
                  </div>
                </div>
